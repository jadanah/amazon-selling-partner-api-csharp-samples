...
{
    public class RestSharpAwsSignerHelperTest
    {
        ...
        private RestSharpAwsSignerHelper awsSignerHelperUnderTest;

        public RestSharpAwsSignerHelperTest()
        {
            var mockDateHelper = new Mock<IDateHelper>();
            mockDateHelper.Setup(dateHelper => dateHelper.GetUtcNow()).Returns(SigningDate);
            awsSignerHelperUnderTest = new RestSharpAwsSignerHelper() { DateHelper = mockDateHelper.Object };
        }
        ...
        public void TestInitializeHeadersSetsUtcNowXAmzDateHeader()
        {
            ...
            Parameter actualParameter = request.Parameters.Find(parameter =>
                ParameterType.HttpHeader.Equals(parameter.Type) && parameter.Name == RestSharpAwsSignerHelper.XAmzDateHeaderName);
        ...
        {
            IRestRequest request = new RestRequest();
            request.AddHeader(RestSharpAwsSignerHelper.XAmzDateHeaderName, "foobar");
        ...
        public void TestAddSignatureToRequest()
        {
            ...
            Parameter actualParameter = restRequest.Parameters.Find(parameter =>
                ParameterType.HttpHeader.Equals(parameter.Type) && parameter.Name == RestSharpAwsSignerHelper.AuthorizationHeaderName);
        ...
        public void TestInitializeHeadersSetsHostHeader()
        {
            ...
            Parameter actualParamter = restRequest.Parameters.Find(parameter =>
                ParameterType.HttpHeader.Equals(parameter.Type) && parameter.Name == RestSharpAwsSignerHelper.HostHeaderName);
        ...
        public void TestInitializeHeadersOverwritesHostHeader()
        {
            ...
            restRequest.AddHeader(RestSharpAwsSignerHelper.HostHeaderName, "foobar");
