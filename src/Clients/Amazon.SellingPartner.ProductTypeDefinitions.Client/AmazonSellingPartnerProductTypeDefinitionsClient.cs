...
namespace Amazon.SellingPartner.ProductTypeDefinitions.Client
{
    ...
    public partial interface IAmazonSellingPartnerProductTypeDefinitionsClient
    {
        ...
        ProductTypeList SearchDefinitionsProductTypes(System.Collections.Generic.IEnumerable<string> marketplaceIds, System.Collections.Generic.IEnumerable<string> keywords = null);
        ...
        /// <exception cref="AmazonSellingPartnerProductTypeDefinitionsApiException">A server side error occurred.</exception>
        ProductTypeDefinition GetDefinitionsProductType(string productType, System.Collections.Generic.IEnumerable<string> marketplaceIds, string sellerId = null, string productTypeVersion = null, Requirements? requirements = null, RequirementsEnforced? requirementsEnforced = null, Locale? locale = null);
    ...
    public partial class AmazonSellingPartnerProductTypeDefinitionsClient : IAmazonSellingPartnerProductTypeDefinitionsClient
    {
        ...
        /// <returns>Successfully retrieved a list of Amazon product types that have definitions available.</returns>
        /// <exception cref="AmazonSellingPartnerProductTypeDefinitionsApiException">A server side error occurred.</exception>
        public virtual ProductTypeList SearchDefinitionsProductTypes(System.Collections.Generic.IEnumerable<string> marketplaceIds, System.Collections.Generic.IEnumerable<string> keywords = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await SearchDefinitionsProductTypesAsync(marketplaceIds, keywords, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Successfully retrieved an Amazon product type definition.</returns>
        /// <exception cref="AmazonSellingPartnerProductTypeDefinitionsApiException">A server side error occurred.</exception>
        public virtual ProductTypeDefinition GetDefinitionsProductType(string productType, System.Collections.Generic.IEnumerable<string> marketplaceIds, string sellerId = null, string productTypeVersion = null, Requirements? requirements = null, RequirementsEnforced? requirementsEnforced = null, Locale? locale = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetDefinitionsProductTypeAsync(productType, marketplaceIds, sellerId, productTypeVersion, requirements, requirementsEnforced, locale, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
