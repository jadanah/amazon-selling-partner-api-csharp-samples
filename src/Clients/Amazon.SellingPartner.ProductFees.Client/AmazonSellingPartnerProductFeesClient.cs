...
namespace Amazon.SellingPartner.ProductFees.Client
{
    ...
    public partial class AmazonSellingPartnerProductFeesClient : IAmazonSellingPartnerProductFeesClient
    {
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerProductFeesApiException">A server side error occurred.</exception>
        public virtual GetMyFeesEstimateResponse GetMyFeesEstimateForSKU(GetMyFeesEstimateRequest body, string sellerSKU)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetMyFeesEstimateForSKUAsync(body, sellerSKU, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerProductFeesApiException">A server side error occurred.</exception>
        public virtual GetMyFeesEstimateResponse GetMyFeesEstimateForASIN(GetMyFeesEstimateRequest body, string asin)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetMyFeesEstimateForASINAsync(body, asin, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
