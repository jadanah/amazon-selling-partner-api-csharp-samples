...
namespace Amazon.SellingPartner.Sales.Client
{
    ...
    public partial interface IAmazonSellingPartnerSalesClient
    {
        ...
        GetOrderMetricsResponse GetOrderMetrics(System.Collections.Generic.IEnumerable<string> marketplaceIds, string interval, Granularity granularity, string granularityTimeZone = null, BuyerType? buyerType = null, string fulfillmentNetwork = null, FirstDayOfWeek? firstDayOfWeek = null, string asin = null, string sku = null);
    ...
    public partial class AmazonSellingPartnerSalesClient : IAmazonSellingPartnerSalesClient
    {
        ...
        /// <returns>OrderMetric action taken on the resource OrderMetrics.</returns>
        /// <exception cref="AmazonSellingPartnerSalesApiException">A server side error occurred.</exception>
        public virtual GetOrderMetricsResponse GetOrderMetrics(System.Collections.Generic.IEnumerable<string> marketplaceIds, string interval, Granularity granularity, string granularityTimeZone = null, BuyerType? buyerType = null, string fulfillmentNetwork = null, FirstDayOfWeek? firstDayOfWeek = null, string asin = null, string sku = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetOrderMetricsAsync(marketplaceIds, interval, granularity, granularityTimeZone, buyerType, fulfillmentNetwork, firstDayOfWeek, asin, sku, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
