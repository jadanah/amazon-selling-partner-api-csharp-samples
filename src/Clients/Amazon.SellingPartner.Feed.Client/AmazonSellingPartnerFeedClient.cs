...
namespace Amazon.SellingPartner.Feed.Client
{
    ...
    public partial interface IAmazonSellingPartnerFeedClient
    {
        ...
        GetFeedsResponse GetFeeds(System.Collections.Generic.IEnumerable<string> feedTypes = null, System.Collections.Generic.IEnumerable<string> marketplaceIds = null, int? pageSize = null, System.Collections.Generic.IEnumerable<Anonymous> processingStatuses = null, System.DateTime? createdSince = null, System.DateTime? createdUntil = null, string nextToken = null);
    ...
    public partial class AmazonSellingPartnerFeedClient : IAmazonSellingPartnerFeedClient
    {
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerFeedApiException">A server side error occurred.</exception>
        public virtual GetFeedsResponse GetFeeds(System.Collections.Generic.IEnumerable<string> feedTypes = null, System.Collections.Generic.IEnumerable<string> marketplaceIds = null, int? pageSize = null, System.Collections.Generic.IEnumerable<Anonymous> processingStatuses = null, System.DateTime? createdSince = null, System.DateTime? createdUntil = null, string nextToken = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetFeedsAsync(feedTypes, marketplaceIds, pageSize, processingStatuses, createdSince, createdUntil, nextToken, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerFeedApiException">A server side error occurred.</exception>
        public virtual CreateFeedResponse CreateFeed(CreateFeedSpecification body)
        {
            return System.Threading.Tasks.Task.Run(async () => await CreateFeedAsync(body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerFeedApiException">A server side error occurred.</exception>
        public virtual void CancelFeed(string feedId)
        {
            System.Threading.Tasks.Task.Run(async () => await CancelFeedAsync(feedId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerFeedApiException">A server side error occurred.</exception>
        public virtual Feed GetFeed(string feedId)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetFeedAsync(feedId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Successfully created a feed document that is ready to receive contents.</returns>
        /// <exception cref="AmazonSellingPartnerFeedApiException">A server side error occurred.</exception>
        public virtual CreateFeedDocumentResponse CreateFeedDocument(CreateFeedDocumentSpecification body)
        {
            return System.Threading.Tasks.Task.Run(async () => await CreateFeedDocumentAsync(body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerFeedApiException">A server side error occurred.</exception>
        public virtual FeedDocument GetFeedDocument(string feedDocumentId)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetFeedDocumentAsync(feedDocumentId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
