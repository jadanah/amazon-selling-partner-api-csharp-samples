...
namespace Amazon.SellingPartner.ProductPricing.Client
{
    ...
    public partial interface IAmazonSellingPartnerProductPricingClient
    {
        ...
        System.Threading.Tasks.Task<GetPricingResponse> GetPricingAsync(string marketplaceId, ItemType itemType, System.Collections.Generic.IEnumerable<string> asins = null, System.Collections.Generic.IEnumerable<string> skus = null, ItemCondition2? itemCondition = null, OfferType2? offerType = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetPricingResponse> GetCompetitivePricingAsync(string marketplaceId, ItemType2 itemType, System.Collections.Generic.IEnumerable<string> asins = null, System.Collections.Generic.IEnumerable<string> skus = null, CustomerType2? customerType = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetOffersResponse> GetListingOffersAsync(string marketplaceId, ItemCondition3 itemCondition, string sellerSKU, CustomerType3? customerType = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetOffersResponse> GetItemOffersAsync(string marketplaceId, ItemCondition4 itemCondition, string asin, CustomerType4? customerType = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Indicates that requests were run in batch.  Check the batch response status lines for information on whether a batch request succeeded.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetItemOffersBatchResponse> GetItemOffersBatchAsync(GetItemOffersBatchRequest getItemOffersBatchRequestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Indicates that requests were run in batch.  Check the batch response status lines for information on whether a batch request succeeded.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetListingOffersBatchResponse> GetListingOffersBatchAsync(GetListingOffersBatchRequest getListingOffersBatchRequestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AmazonSellingPartnerProductPricingClient : IAmazonSellingPartnerProductPricingClient
    {
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetOffersResponse> GetListingOffersAsync(string marketplaceId, ItemCondition3 itemCondition, string sellerSKU, CustomerType3? customerType = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (sellerSKU == null)
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetOffersResponse> GetItemOffersAsync(string marketplaceId, ItemCondition4 itemCondition, string asin, CustomerType4? customerType = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (asin == null)
        ...
        /// <returns>Indicates that requests were run in batch.  Check the batch response status lines for information on whether a batch request succeeded.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetItemOffersBatchResponse> GetItemOffersBatchAsync(GetItemOffersBatchRequest getItemOffersBatchRequestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (getItemOffersBatchRequestBody == null)
                throw new System.ArgumentNullException("getItemOffersBatchRequestBody");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("batches/products/pricing/v0/itemOffers");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(getItemOffersBatchRequestBody, _settings.Value));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetItemOffersBatchResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AmazonSellingPartnerProductPricingApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new AmazonSellingPartnerProductPricingApiException<Errors>("Request has missing or invalid parameters and cannot be parsed.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 401)
                        {
                            ...
                            throw new AmazonSellingPartnerProductPricingApiException<Errors>("The request\'s Authorization header is not formatted correctly or does not contain a valid token.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 403)
                        {
                            ...
                            throw new AmazonSellingPartnerProductPricingApiException<Errors>("Indicates access to the resource is forbidden. Possible reasons include Access Denied, Unauthorized, Expired Token, or Invalid Signature.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
                            ...
                            throw new AmazonSellingPartnerProductPricingApiException<Errors>("The specified resource does not exist.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 429)
                        {
                            ...
                            throw new AmazonSellingPartnerProductPricingApiException<Errors>("The frequency of requests was greater than allowed.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
                            ...
                            throw new AmazonSellingPartnerProductPricingApiException<Errors>("An unexpected condition occurred that prevented the server from fulfilling the request.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 503)
                        {
                            ...
                            throw new AmazonSellingPartnerProductPricingApiException<Errors>("Temporary overloading or maintenance of the server.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
        ...
        /// <returns>Indicates that requests were run in batch.  Check the batch response status lines for information on whether a batch request succeeded.</returns>
        /// <exception cref="AmazonSellingPartnerProductPricingApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetListingOffersBatchResponse> GetListingOffersBatchAsync(GetListingOffersBatchRequest getListingOffersBatchRequestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (getListingOffersBatchRequestBody == null)
                throw new System.ArgumentNullException("getListingOffersBatchRequestBody");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("batches/products/pricing/v0/listingOffers");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(getListingOffersBatchRequestBody, _settings.Value));
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
                    request_.Method = new System.Net.Http.HttpMethod("POST");
                    request_.Headers.Accept.Add(System.Net.Http.Headers.MediaTypeWithQualityHeaderValue.Parse("application/json"));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetListingOffersBatchResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new AmazonSellingPartnerProductPricingApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class GetItemOffersBatchRequest
    {
        ...
        public static GetItemOffersBatchRequest FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<GetItemOffersBatchRequest>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetListingOffersBatchRequest
    {
        [Newtonsoft.Json.JsonProperty("requests", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        [System.ComponentModel.DataAnnotations.MaxLength(20)]
        public ListingOffersRequestList Requests { get; set; }
        ...
        public static GetListingOffersBatchRequest FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<GetListingOffersBatchRequest>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ListingOffersRequestList : System.Collections.ObjectModel.Collection<ListingOffersRequest>
    {
        ...
        public static ListingOffersRequestList FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ListingOffersRequestList>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ItemOffersRequestList : System.Collections.ObjectModel.Collection<ItemOffersRequest>
    {
        ...
        public static ItemOffersRequestList FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ItemOffersRequestList>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class BatchOffersRequestParams
    {
        ...
        public static BatchOffersRequestParams FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<BatchOffersRequestParams>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ItemOffersRequest : BatchRequest
    {
        [Newtonsoft.Json.JsonProperty("MarketplaceId", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string MarketplaceId { get; set; }
        ...
        public static ItemOffersRequest FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ItemOffersRequest>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ListingOffersRequest : BatchRequest
    {
        [Newtonsoft.Json.JsonProperty("MarketplaceId", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string MarketplaceId { get; set; }
        ...
        public static ListingOffersRequest FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ListingOffersRequest>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetItemOffersBatchResponse
    {
        ...
        public static GetItemOffersBatchResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<GetItemOffersBatchResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetListingOffersBatchResponse
    {
        [Newtonsoft.Json.JsonProperty("responses", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.MinLength(1)]
        [System.ComponentModel.DataAnnotations.MaxLength(20)]
        ...
        public static GetListingOffersBatchResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<GetListingOffersBatchResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ItemOffersResponseList : System.Collections.ObjectModel.Collection<ItemOffersResponse>
    {
        ...
        public static ItemOffersResponseList FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ItemOffersResponseList>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ListingOffersResponseList : System.Collections.ObjectModel.Collection<ListingOffersResponse>
    {
        ...
        public static ListingOffersResponseList FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ListingOffersResponseList>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class BatchOffersResponse
    {
        ...
        public GetOffersResponse Body { get; set; } = new GetOffersResponse();
        ...
        public static BatchOffersResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<BatchOffersResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ItemOffersRequestParams : BatchOffersRequestParams
    {
        /// <summary>
        ...
        public static ItemOffersRequestParams FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ItemOffersRequestParams>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ItemOffersResponse : BatchOffersResponse
    {
        ...
        public static ItemOffersResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ItemOffersResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ListingOffersRequestParams : BatchOffersRequestParams
    {
        /// <summary>
        ...
        public static ListingOffersRequestParams FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ListingOffersRequestParams>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ListingOffersResponse : BatchOffersResponse
    {
        ...
        public static ListingOffersResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<ListingOffersResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class Errors
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public ErrorList Errors1 { get; set; } = new ErrorList();
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class HttpRequestHeaders : System.Collections.Generic.Dictionary<string, string>
    {
        ...
        public static HttpRequestHeaders FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<HttpRequestHeaders>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class HttpResponseHeaders
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("x-amzn-RequestId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static HttpResponseHeaders FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<HttpResponseHeaders>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class GetOffersHttpStatusLine
    {
        /// <summary>
        ...
        public static GetOffersHttpStatusLine FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<GetOffersHttpStatusLine>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class BatchRequest
    {
        ...
        public static BatchRequest FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<BatchRequest>(data, new Newtonsoft.Json.JsonSerializerSettings());
