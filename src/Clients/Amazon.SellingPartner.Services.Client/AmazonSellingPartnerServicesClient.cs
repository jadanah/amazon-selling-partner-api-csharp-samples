...
namespace Amazon.SellingPartner.Services.Client
{
    ...
    public partial interface IAmazonSellingPartnerServicesClient
    {
        ...
        /// <returns>Success response</returns>
        /// <exception cref="AmazonSellingPartnerServicesApiException">A server side error occurred.</exception>
        GetServiceJobsResponse GetServiceJobs(System.Collections.Generic.IEnumerable<string> marketplaceIds, System.Collections.Generic.IEnumerable<string> serviceOrderIds = null, System.Collections.Generic.IEnumerable<Anonymous> serviceJobStatus = null, string pageToken = null, int? pageSize = null, SortField? sortField = null, SortOrder? sortOrder = null, string createdAfter = null, string createdBefore = null, string lastUpdatedAfter = null, string lastUpdatedBefore = null, string scheduleStartDate = null, string scheduleEndDate = null);
    ...
    public partial class AmazonSellingPartnerServicesClient : IAmazonSellingPartnerServicesClient
    {
        ...
        /// <returns>Success response</returns>
        /// <exception cref="AmazonSellingPartnerServicesApiException">A server side error occurred.</exception>
        public virtual GetServiceJobByServiceJobIdResponse GetServiceJobByServiceJobId(string serviceJobId)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetServiceJobByServiceJobIdAsync(serviceJobId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success response</returns>
        /// <exception cref="AmazonSellingPartnerServicesApiException">A server side error occurred.</exception>
        public virtual CancelServiceJobByServiceJobIdResponse CancelServiceJobByServiceJobId(string serviceJobId, string cancellationReasonCode)
        {
            return System.Threading.Tasks.Task.Run(async () => await CancelServiceJobByServiceJobIdAsync(serviceJobId, cancellationReasonCode, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success response</returns>
        /// <exception cref="AmazonSellingPartnerServicesApiException">A server side error occurred.</exception>
        public virtual CompleteServiceJobByServiceJobIdResponse CompleteServiceJobByServiceJobId(string serviceJobId)
        {
            return System.Threading.Tasks.Task.Run(async () => await CompleteServiceJobByServiceJobIdAsync(serviceJobId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success response</returns>
        /// <exception cref="AmazonSellingPartnerServicesApiException">A server side error occurred.</exception>
        public virtual GetServiceJobsResponse GetServiceJobs(System.Collections.Generic.IEnumerable<string> marketplaceIds, System.Collections.Generic.IEnumerable<string> serviceOrderIds = null, System.Collections.Generic.IEnumerable<Anonymous> serviceJobStatus = null, string pageToken = null, int? pageSize = null, SortField? sortField = null, SortOrder? sortOrder = null, string createdAfter = null, string createdBefore = null, string lastUpdatedAfter = null, string lastUpdatedBefore = null, string scheduleStartDate = null, string scheduleEndDate = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetServiceJobsAsync(marketplaceIds, serviceOrderIds, serviceJobStatus, pageToken, pageSize, sortField, sortOrder, createdAfter, createdBefore, lastUpdatedAfter, lastUpdatedBefore, scheduleStartDate, scheduleEndDate, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success response</returns>
        /// <exception cref="AmazonSellingPartnerServicesApiException">A server side error occurred.</exception>
        public virtual SetAppointmentResponse AddAppointmentForServiceJobByServiceJobId(string serviceJobId, AddAppointmentRequest body)
        {
            return System.Threading.Tasks.Task.Run(async () => await AddAppointmentForServiceJobByServiceJobIdAsync(serviceJobId, body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success response</returns>
        /// <exception cref="AmazonSellingPartnerServicesApiException">A server side error occurred.</exception>
        public virtual SetAppointmentResponse RescheduleAppointmentForServiceJobByServiceJobId(string serviceJobId, string appointmentId, RescheduleAppointmentRequest body)
        {
            return System.Threading.Tasks.Task.Run(async () => await RescheduleAppointmentForServiceJobByServiceJobIdAsync(serviceJobId, appointmentId, body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
