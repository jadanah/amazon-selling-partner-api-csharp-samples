...
namespace Amazon.SellingPartner.FbaInboundEligility.Client
{
    ...
    public partial interface IAmazonSellingPartnerFbaInboundEligilityClient
    {
        ...
        GetItemEligibilityPreviewResponse GetItemEligibilityPreview(string asin, Program program, System.Collections.Generic.IEnumerable<string> marketplaceIds = null);
    ...
    public partial class AmazonSellingPartnerFbaInboundEligilityClient : IAmazonSellingPartnerFbaInboundEligilityClient
    {
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerFbaInboundEligilityApiException">A server side error occurred.</exception>
        public virtual GetItemEligibilityPreviewResponse GetItemEligibilityPreview(string asin, Program program, System.Collections.Generic.IEnumerable<string> marketplaceIds = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetItemEligibilityPreviewAsync(asin, program, marketplaceIds, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
