...
namespace Amazon.SellingPartner.Orders.Client
{
    ...
    public partial interface IAmazonSellingPartnerOrdersClient
    {
        ...
        /// <param name="fulfillmentChannels">A list that indicates how an order was fulfilled. Filters the results by fulfillment channel. Possible values: FBA (Fulfillment by Amazon); SellerFulfilled (Fulfilled by the seller).</param>
        ...
        GetOrdersResponse GetOrders(System.Collections.Generic.IEnumerable<string> marketplaceIds, string createdAfter = null, string createdBefore = null, string lastUpdatedAfter = null, string lastUpdatedBefore = null, System.Collections.Generic.IEnumerable<string> orderStatuses = null, System.Collections.Generic.IEnumerable<string> fulfillmentChannels = null, System.Collections.Generic.IEnumerable<string> paymentMethods = null, string buyerEmail = null, string sellerOrderId = null, int? maxResultsPerPage = null, System.Collections.Generic.IEnumerable<string> easyShipShipmentStatuses = null, string nextToken = null, System.Collections.Generic.IEnumerable<string> amazonOrderIds = null, string actualFulfillmentSupplySourceId = null, bool? isISPU = null, string storeChainStoreId = null);
    ...
    public partial class AmazonSellingPartnerOrdersClient : IAmazonSellingPartnerOrdersClient
    {
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerOrdersApiException">A server side error occurred.</exception>
        public virtual GetOrdersResponse GetOrders(System.Collections.Generic.IEnumerable<string> marketplaceIds, string createdAfter = null, string createdBefore = null, string lastUpdatedAfter = null, string lastUpdatedBefore = null, System.Collections.Generic.IEnumerable<string> orderStatuses = null, System.Collections.Generic.IEnumerable<string> fulfillmentChannels = null, System.Collections.Generic.IEnumerable<string> paymentMethods = null, string buyerEmail = null, string sellerOrderId = null, int? maxResultsPerPage = null, System.Collections.Generic.IEnumerable<string> easyShipShipmentStatuses = null, string nextToken = null, System.Collections.Generic.IEnumerable<string> amazonOrderIds = null, string actualFulfillmentSupplySourceId = null, bool? isISPU = null, string storeChainStoreId = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetOrdersAsync(marketplaceIds, createdAfter, createdBefore, lastUpdatedAfter, lastUpdatedBefore, orderStatuses, fulfillmentChannels, paymentMethods, buyerEmail, sellerOrderId, maxResultsPerPage, easyShipShipmentStatuses, nextToken, amazonOrderIds, actualFulfillmentSupplySourceId, isISPU, storeChainStoreId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerOrdersApiException">A server side error occurred.</exception>
        public virtual GetOrderResponse GetOrder(string orderId)
        {
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerOrdersApiException">A server side error occurred.</exception>
        public virtual GetOrderBuyerInfoResponse GetOrderBuyerInfo(string orderId)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetOrderBuyerInfoAsync(orderId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerOrdersApiException">A server side error occurred.</exception>
        public virtual GetOrderAddressResponse GetOrderAddress(string orderId)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetOrderAddressAsync(orderId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerOrdersApiException">A server side error occurred.</exception>
        public virtual GetOrderItemsResponse GetOrderItems(string orderId, string nextToken = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetOrderItemsAsync(orderId, nextToken, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerOrdersApiException">A server side error occurred.</exception>
        public virtual GetOrderItemsBuyerInfoResponse GetOrderItemsBuyerInfo(string orderId, string nextToken = null)
        {
            return System.Threading.Tasks.Task.Run(async () => await GetOrderItemsBuyerInfoAsync(orderId, nextToken, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Success.</returns>
        /// <exception cref="AmazonSellingPartnerOrdersApiException">A server side error occurred.</exception>
        public virtual void UpdateShipmentStatus(string orderId, UpdateShipmentStatusRequest payload)
        {
            System.Threading.Tasks.Task.Run(async () => await UpdateShipmentStatusAsync(orderId, payload, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
